...
export class textBox{
	...
	render(start=0,end=-1){
		let formated = fitPage(this.format(this.origin))
...
export function show(content,bottom=[],startPoint=[0,0]){
	console.clear()
	content.forEach((item,index)=>{
		moveCursor(startPoint.add([0,index]))
		print(item)
	})
